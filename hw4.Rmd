...
# Clean data
music <- select(music, - "...1", -artist_name, -track_name) %>% 
...
From the average scores above, there are several observations:
  ...
  - **Jazz** can very much be singled out by its high `instrumentalness` (~less vocal) which is distinct from other genres.
