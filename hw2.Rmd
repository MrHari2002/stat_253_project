...
- OLS is best
- Analysis goals: see the trend of each musical features across the years. More on predictive accuracy. 
- P-values: all are very low, so all the null hypothesis are rejected.
- Prediction range: sd is 11.24 years
- Predictive accuracy: 12.0784177 years
- Prediction power: rsq = 0.3701227 - not high, but not too low -> interpret predictors with high absolute value of coefficients
